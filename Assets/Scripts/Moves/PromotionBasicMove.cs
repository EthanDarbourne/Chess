...
{
    public class PromotionBasicMove : BasicMove, IPromotionMove
    {
        private PieceType _promoteTo;

        public PromotionBasicMove( Square from, Square to, PieceType promoteTo, string boardHash, bool isCheck = false, bool isCheckmate = false )
